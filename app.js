const dict = {
      zh: {
        'nav.product':'产品说明','nav.workflow':'工作流程','nav.structure':'问卷结构','nav.result':'示例结果','nav.about':'产品说明','nav.notes':'工作流程','nav.contact':'联系','nav.example':'示例','nav.cta':'申请试用',
      ...
      en: {
        'nav.product':'Product','nav.workflow':'Workflow','nav.structure':'Survey structure','nav.result':'Example result','nav.about':'Product','nav.notes':'Workflow','nav.contact':'Contact','nav.example':'Example','nav.cta':'Request trial',
