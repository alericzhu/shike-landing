const dict = {
      zh: {
        ...
        'cta.kicker':'Designer trial','cta.title':'给设计师一个更清楚的项目开始方式。','cta.text':'Shike 适合在初次沟通、签约前调研和方案启动前使用。现在先小范围开放试用，真实项目数据只进入对应设计师的工作流。','cta.trial':'申请试用','cta.result':'查看示例结果 →','cta.demo':'体验示例问卷 →',
      ...
      en: {
        'nav.product':'Product','nav.workflow':'Workflow','nav.structure':'Survey structure','nav.result':'Example result','nav.about':'Product','nav.notes':'Workflow','nav.contact':'Contact','nav.example':'Example','nav.demo':'Try survey','nav.cta':'Request trial',
        'visual.kicker':'Visual references','visual.title':'Let clients see the feeling before describing the requirement.','visual.text':'Many spatial preferences are hard to explain with words alone. Images, scenes and lifestyle questions reveal what clients truly care about earlier.','visual.l1':'design worktable','visual.l2':'reference board','visual.l3':'summary report','home.eyebrow':'Interior design intake system','home.title':'Turn vague client language into information designers can judge.','home.lead':'Shike is a lightweight tool for early interior design conversations. It helps designers clarify lifestyle habits, spatial preferences, visual references and communication priorities before a project starts.','home.trial':'Request designer trial','home.demo':'Try example survey →','home.note':'Now open to a small group of independent designers and studios; the example survey does not save real project data.','home.workflow':'About the workflow →','home.cardTitle':'Design Survey','home.status':'example flow','home.q1':'How does your family usually spend weekends at home?','home.a1':'Cooking, childcare and tidying storage, with occasional friends over for dinner.','home.q2':'Which references feel closest to your ideal atmosphere?','home.q3':'Do you cook frequently during weekdays?','home.insightKicker':'Organized result','home.insightText':'Prefers warm restraint; key signals are kitchen circulation, shared-area storage and the visual boundary of “not too cold”.',
        ...
        'cta.kicker':'Designer trial','cta.title':'A clearer way for designers to start a project.','cta.text':'Shike works well for first conversations, pre-contract research and project kickoff preparation. It is now open for a small trial, with real project data kept inside each designer workflow.','cta.trial':'Request trial','cta.result':'View example result →','cta.demo':'Try example survey →',
